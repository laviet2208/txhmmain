...
class bottom_page_pc_decoration extends StatelessWidget {
  const bottom_page_pc_decoration({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: 0, right: width/2),
            child: Container(
              height: (width/2)/(535/150),
              decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
