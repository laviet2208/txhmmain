...
import 'package:txhmmain/screen/mobile_screen/mobile_view_product_detail_screen/ingredient/notify_when_in_stock/notify_when_in_stock.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: 10, right: 10),
            child: Container(
              height: (widget.product.inventory == 0 && widget.product.saleType == 2) ? 30 : 0,
              decoration: (widget.product.inventory == 0 && widget.product.saleType == 2) ? BoxDecoration(
                color: Colors.white,
                border: Border.all(
                  width: 0.5,
                  color: Colors.red,
