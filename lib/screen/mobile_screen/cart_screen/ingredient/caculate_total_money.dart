...
import 'voucher_select/voucher_select.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            cost_text_line(title: 'Items (' + finalData.cartList.length.toString() + ')', content: getStringNumber(calculatetotalMoney()) + ' .VNĐ', size: width/25, contentColor: Colors.black, titleColor: Colors.grey,),

            SizedBox(height: 10,),

            GestureDetector(
              child: cost_text_line(title: 'Voucher', content: (widget.voucher.id == '' ? 'Chọn mã giảm giá' : ('- ' + getStringNumber(getVoucherSale(widget.voucher, calculatetotalMoney())) + ' .vnđ')), size: width/25, contentColor: Colors.blue, titleColor: Colors.grey,),
              onTap: () {
            ...
            cost_text_line(title: 'Tổng tiền', content: getStringNumber(calculatetotalMoney() - getVoucherSale(widget.voucher, calculatetotalMoney())) + ' .vnđ', size: width/25, contentColor: Colors.black, titleColor: Colors.black,),
