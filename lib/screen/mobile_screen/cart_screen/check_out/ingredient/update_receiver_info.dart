...
import '../../ingredient/edit_text_in_signup_step_1.dart';
...
class _update_receiver_infoState extends State<update_receiver_info> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text('Cập nhật thông tin', style: TextStyle(fontFamily: 'muli', fontSize: width/25, fontWeight: FontWeight.bold),),
